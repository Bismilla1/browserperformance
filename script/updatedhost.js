module.exports = async function (context, commands) {
    ...
    try {
      ...
      await commands.addText.byXpath("host1@qobox.com", "//input[@id='user_email']");
      await commands.wait.byXpath("//input[@id='user_password']", 50000);
      await commands.addText.byXpath("qoboxhost123", "//input[@id='user_password']");
      ...
      let examDate = new Date();
      date = (1 + examDate.getDate()).toString().padStart(2, '0') 
      month = (1+ examDate.getMonth()).toString().padStart(2, '0')
      year = examDate.getFullYear()
      let selectDate = month.toString()+ date.toString()+year.toString();
      await commands.addText.byXpath(selectDate, "//input[@id='exam_start_date']");
